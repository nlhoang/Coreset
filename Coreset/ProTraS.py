...
----------------------------------------------------------------------------------------------------
New FFT Coreset
By NLHOANG (from Ros and Guillaume in 'ProTraS: A probabilistic traversaling sampling algorithm' (2018))
...
'''
----------------------------------------------------------------------------------------------------
New ProTraS Coreset with Time Record
By NLHOANG - for Saving ProTraS Coreset
# Input: X = dataset; m = number of coreset elements
